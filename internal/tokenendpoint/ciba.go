...
//
// audience selection: the bc-authorize record may have stamped
// multiple normalised resource indicators, but the issuance
...
// multi-aud tokens via CIBA flow would need a wiring extension
