// Module github.com/libraz/go-oidc-provider/examples/07-mysql-store wires
// the SQL storage adapter against a MySQL engine. It is its own sub-module
// so the MySQL driver dependency stays out of the main module's go.sum.
module github.com/libraz/go-oidc-provider/examples/07-mysql-store
