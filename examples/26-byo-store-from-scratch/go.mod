// Module github.com/libraz/go-oidc-provider/examples/26-byo-store-from-scratch
// implements the whole store.Store aggregate by hand against a SQLite
// database whose table and column names look nothing like the OP's
// bundled schema. It is its own sub-module so the SQL driver dependency
// stays out of the main module's go.sum.
module github.com/libraz/go-oidc-provider/examples/26-byo-store-from-scratch
