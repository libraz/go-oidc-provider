// Module github.com/libraz/go-oidc-provider/examples/06-sql-store wires
// the SQL storage adapter into a runnable example. It is its own
// sub-module so the SQL driver dependencies stay out of the main
// module's go.sum.
module github.com/libraz/go-oidc-provider/examples/06-sql-store
