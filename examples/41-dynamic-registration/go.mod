// Module github.com/libraz/go-oidc-provider/examples/41-dynamic-registration
// pairs the RFC 7591 / RFC 7592 OP with an in-process RP that
// self-registers via the IAT, then drives Authorization Code + PKCE
// against the dynamic client_id. It is its own sub-module so the
