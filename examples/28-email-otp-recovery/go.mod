// Module github.com/libraz/go-oidc-provider/examples/28-email-otp-recovery
// demonstrates the two delivery-channel second factors — a mailed
// one-time code and a printed recovery sheet — against an in-process
// RP built on examples/internal/rpkit, with the user seeded through
