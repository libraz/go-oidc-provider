// Module github.com/libraz/go-oidc-provider/examples/17-spa-composite-store
// pairs the SPA interaction seam with the hot/cold storage split:
// MySQL durable + Redis volatile through op/storeadapter/composite,
// with login and consent rendered by a single-page bundle. It is its
// own sub-module so the SQL and Redis driver dependencies stay out of
