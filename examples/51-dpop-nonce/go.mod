// Module github.com/libraz/go-oidc-provider/examples/51-dpop-nonce pairs
// the OP's RFC 9449 §8 DPoP nonce challenge with an in-process FAPI 2.0
// RP from examples/internal/rpkit. It is its own sub-module so the
// RP-side dependencies (golang.org/x/oauth2, github.com/coreos/go-oidc/v3,
