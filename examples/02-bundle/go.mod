// Module github.com/libraz/go-oidc-provider/examples/02-bundle
// pairs the comprehensive option-bundle wiring example with an
// in-process RP built on examples/internal/rpkit and a seeded user
// from examples/internal/seedkit. It is its own sub-module so the
