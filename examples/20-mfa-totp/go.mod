// Module github.com/libraz/go-oidc-provider/examples/20-mfa-totp pairs
// the always-on password+TOTP demo with an in-process RP built on
// examples/internal/rpkit and a TOTP enrolment seeded through
...
module github.com/libraz/go-oidc-provider/examples/20-mfa-totp
